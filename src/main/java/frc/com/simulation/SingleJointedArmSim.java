...
public class SingleJointedArmSim extends LinearSystemSim<N2, N1, N2> {
  ...
  // The effective gravity of the system.
  private final double m_effectiveAlphaGravity;
  ...
  public SingleJointedArmSim(
    ...
    m_effectiveAlphaGravity = kG * m_plant.getB(1, 0);
    ...
    Matrix<N2, N1> updatedXhat = NumericalIntegration.rkdp(
        (Matrix<N2, N1> x, Matrix<N1, N1> _u) -> {
          ...
          if (m_simulateGravity) {
            double alphaGrav = -m_effectiveAlphaGravity * Math.cos(x.get(0, 0));
  ...
  public double getEffectiveAlphaGravity() {
    return this.m_effectiveAlphaGravity;
  }
}